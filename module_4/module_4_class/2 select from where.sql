...
INSERT INTO employees (employee_id, first_name, last_name, email, state)
VALUES 
    (1, 'John', 'Doe', 'james.madison@hi.com', 'NY'),
    (2, 'Jane', 'Smith', 'john.mclean@hi.com', 'NY'),
    (3, 'Bob', 'Johnson', 'james.buchanan@hi.com', 'US');
